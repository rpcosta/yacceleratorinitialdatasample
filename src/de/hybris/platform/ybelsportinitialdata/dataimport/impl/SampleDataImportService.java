 ...
 */
package cl.com.bls.b2c.bld.initialdata.dataimport.impl;
...
public class SampleDataImportService extends AbstractDataImportService
{
	...
	public void execute(final AbstractSystemSetup systemSetup, final SystemSetupContext context, final List<ImportData> importData)
	{
		...
		importSampleProductsAndPromotions = getConfigurationService().getConfiguration().getBoolean(SAMPLE_DATA_LOAD, false);
	...
	protected void importProductCatalog(final String extensionName, final String productCatalogName)
	{
		...
		if (importSampleProductsAndPromotions) {
			...
			getSetupImpexService()
					.importImpexFile(String.format("/%s/import/sampledata/productCatalogs/%sProductCatalog/products-categories.impex",
							extensionName, productCatalogName), false);

			// Load Variant Products
			getSetupImpexService()
					.importImpexFile(String.format("/%s/import/sampledata/productCatalogs/%sProductCatalog/variant-products.impex",
							extensionName, productCatalogName), false);

			// Load Variant Products Categories
			getSetupImpexService()
					.importImpexFile(String.format("/%s/import/sampledata/productCatalogs/%sProductCatalog/variant-products-categories.impex",
							extensionName, productCatalogName), false);

			// Load Variant Product Prices
			getSetupImpexService()
					.importImpexFile(String.format("/%s/import/sampledata/productCatalogs/%sProductCatalog/variant-products-prices.impex",
							extensionName, productCatalogName), false);

			// Load Variant Product Stock Levels
			getSetupImpexService()
					.importImpexFile(String.format("/%s/import/sampledata/productCatalogs/%sProductCatalog/variant-products-stocklevels.impex",
							extensionName, productCatalogName), false);

			// Load Products and Variants Promotions
			getSetupImpexService()
					.importImpexFile(String.format("/%s/import/sampledata/productCatalogs/%sProductCatalog/product-categories-with-promotions.impex",
							extensionName, productCatalogName), false);
	...
	protected void importContentCatalog(final String extensionName, final String contentCatalogName)
	{
		...
		getSetupImpexService()
				.importImpexFile(String.format("/%s/import/sampledata/contentCatalogs/%sContentCatalog/menu.impex",
						extensionName, contentCatalogName), false);
